        ...
        <Routes>
            ...
            <Route path="*" element={
                ...
                >
                    ...
                    {activeTab === 'mappings' && <MappingsPage mappings={mappings} candidates={candidates} positions={cargos} onUpdateStatus={updateMappingStatus} onUpdateCargo={updateMapping} onDelete={deleteMapping} showToast={showToast} />}
