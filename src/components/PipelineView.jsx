                ...
                <div className="flex gap-3 items-center flex-wrap">
                    ...
                    {setFilters && (() => {
                        ...
                        <div className="flex items-center rounded-lg border border-gray-200 dark:border-gray-700 bg-brand-card p-0.5" role="group" aria-label="Filtro por estrela">
                            <button type="button" onClick={() => setFilters(prev => ({ ...prev, starredFilter: activeStar === 'starred' ? 'all' : 'starred' }))} className={`p-2 rounded-md transition-colors ${activeStar === 'starred' ? 'bg-white dark:bg-gray-800 shadow-sm' : 'hover:bg-white/10'}`} title="Somente com estrela (em consideração). Clique de novo para mostrar todos.">
                                <Star size={16} className="text-amber-400 fill-amber-400" />
                            </button>
                            <button type="button" onClick={() => setFilters(prev => ({ ...prev, starredFilter: activeStar === 'unstarred' ? 'all' : 'unstarred' }))} className={`p-2 rounded-md transition-colors ${activeStar === 'unstarred' ? 'bg-white dark:bg-gray-800 shadow-sm' : 'hover:bg-white/10'}`} title="Somente sem estrela. Clique de novo para mostrar todos.">
